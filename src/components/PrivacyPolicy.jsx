...
class PrivacyPolicy extends React.Component {
  render() {
    return (
      <div className="fontsizeDecrease" id="privacyPolicy">
        <h3>Airsip Privacy Policy</h3>
        <br />
        <p>
          Last updated: August 04, 2020 This Privacy Policy describes Our
        ...
        <p>
          <span>Affiliate</span> means an entity that controls, is controlled by
        ...
        <p>
          ...
          Company downloaded by You on any electronic device, named Airsip
        </p>
        <p>
        ...
        <p>
          ...
          or "Our" in this Agreement) refers to Eddify Co. , 261 Tom Hunter
          Road. For the purpose of the GDPR, the Company is the Data Controller.
        </p>
        <p>
        ...
        <p>
          <span>Country</span> refers to: New Jersey, United States
        </p>
        <p>
        ...
        <p>
          <span>Do Not Track</span> (DNT) is a concept that has been promoted by
        ...
        <p>
          <span>Third-party Social Media Service</span> refers to any website or
        ...
        <p>
          ...
          <ul className="removeBulletPoint">
            <li>Email address</li>
          ...
          <ul className="removeBulletPoint">
            <li>
              ...
              <p>
                ...
                Policy: https://policies.google.com/privacy <br />
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <span>Vital interests:</span> Processing Personal Data is
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <span>Object to processing of Your Personal Data.</span> This
            ...
            <li>
              ...
              which You initially provided consent for Us to use or where We
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <span>The right not to be discriminated against.</span> You have
        ...
        <p>
          ...
          <br />
          <ul className="removeBulletPoint">
            <li>By email: seansoohyunkwon@gmail.com</li>
            <li>By visiting this page on our website: airsip.co</li>
          </ul>
        </p>
      </div>
    );
